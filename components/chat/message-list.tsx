  ...
  if (messages.length === 0) {
    return (
      <div className="flex flex-1 flex-col items-center justify-center p-8 text-center">
        ...
        <h2 className="text-2xl font-bold text-zinc-900 dark:text-zinc-100">Clitronic</h2>
        <p className="mt-2 max-w-md text-zinc-500 dark:text-zinc-400">
          Your AI companion for learning electronics. Ask about components, circuits, or upload a
          photo to identify parts.
        </p>
